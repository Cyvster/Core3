...
function DathomirStaticSpawnsSeScreenPlay:spawnMobiles()
	...
	--knight trial mobs static spawn dathomir (4224 -3730)
	spawnMobile("dathomir", "tusken_raider", 1800, 4159.4, 82.6, -3789.2, 49, 0)
	spawnMobile("dathomir", "ancient_bull_rancor", 1800, 4166.8, 93.2, -3648, 137, 0)
	spawnMobile("dathomir", "stintaril_prowler", 1800, 4306.7, 91.9, -3625.1, -158, 0)
	spawnMobile("dathomir", "blurrg_raptor", 1800, 4354.9, 80.1, -3747.9, -88, 0)
	spawnMobile("dathomir", "enraged_kimogila", 1800, 4253.2, 83.5, -3833.3, 4, 0)
	spawnMobile("dathomir", "peko_peko_albatross", 1800, 4241.8, 79.2, -3735.4, 0, 0)
	spawnMobile("dathomir", "graul_marauder", 1800, 4240.8, 97.8, -3952.1, 1, 0)
	spawnMobile("dathomir", "storm_commando", 1800, 4119.7, 79.8, -3926.0, 34, 0)
	spawnMobile("dathomir", "rebel_commando", 1800, 4028.3, 88.0, -3814.4, 72, 0)
	spawnMobile("dathomir", "imperial_surface_marshal", 1800, 4058.0, 115.3, -3598.1, 121, 0)
	spawnMobile("dathomir", "stormtrooper_novatrooper_elite_commander", 1800, 4186.7, 117.9, -3528.7, 155, 0)
	spawnMobile("dathomir", "corvette_rebel_rear_admiral", 1800, 4328.9, 107.7, -3545.3, -175, 0)
	spawnMobile("dathomir", "geonosian_acklay_bunker_boss", 1800, 4437.0, 94.5, -3621.3, -116, 0)
	spawnMobile("dathomir", "nightsister_elder", 1800, 4446.0, 79.3, -3798.6, -73, 0)
	spawnMobile("dathomir", "gaping_spider_recluse_giant_kiin_dray", 1800, 4320.2, 90.6, -3928.7, -24, 0)
