...
function DathomirStaticSpawnsSeScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "imperial_general", 1800, 4058.0, 115.3, -3598.1, 121, 0)
	spawnMobile("dathomir", "rebel_general", 1800, 4186.7, 117.9, -3528.7, 155, 0)
	spawnMobile("dathomir", "elite_novatrooper_commander", 1800, 4328.9, 107.7, -3545.3, -175, 0)
	spawnMobile("dathomir", "rebel_rear_admiral", 1800, 4437.0, 94.5, -3621.3, -116, 0)
