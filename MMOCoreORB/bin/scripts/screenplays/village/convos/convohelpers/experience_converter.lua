...
ExperienceConverter = ScreenPlay:new {
	xpConversion = {
		combat = {
			{ "bountyhunter", 1 },
			{ "combat_general", 1 },
			{ "combat_meleespecialize_onehand", 3 },
			{ "combat_meleespecialize_polearm", 3 },
			{ "combat_meleespecialize_twohand", 3 },
			{ "combat_meleespecialize_unarmed", 3 },
			{ "combat_rangedspecialize_carbine", 3 },
			{ "combat_rangedspecialize_heavy", 3 },
			{ "combat_rangedspecialize_pistol", 3 },
			{ "combat_rangedspecialize_rifle", 3 },
			{ "squadleader", 9 }
		},
		senses = {
