...
function villageSivarraPhase4ConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	elseif ((QuestManager.hasActiveQuest(pPlayer, QuestManager.quests.FS_COMBAT_HEALING_1) and healCount < 1) or (QuestManager.hasActiveQuest(pPlayer, QuestManager.quests.FS_COMBAT_HEALING_2) and healCount < 100)) then
	...
	elseif (QuestManager.hasActiveQuest(pPlayer, QuestManager.quests.FS_COMBAT_HEALING_2) and healCount >= 1) then
		return convoTemplate:getScreen("intro_give_second_set_reward")
	elseif (QuestManager.hasActiveQuest(pPlayer, QuestManager.quests.FS_COMBAT_HEALING_1) and healCount >= 1) then
