...
Custom Skills is a server-side addon that grants your character bonuses based on the badges you've earned. Bonuses apply to combat, crafting, gathering, movement, buffs, and experience. **Open the menu anytime with:** `/customskills`
...
**Experience Bonus** -- multiplies ALL positive XP (combat, crafting, harvesting, quests); stacks multiplicatively with server and buff rates: 100 XP x 2x server x 5x character = 1,000 XP (10x total, not 7x). Powered by: Corellia exploration (5). Typical maximum: +500%.
...
**Nemotron 3.5 Lightning Free (AI)** -- initial creation. ox-alpha (opencode/x-preview-f-free), 08242026 -- feature-section restructure; modifier/badge reference folded in per owner directive. hy3-free (opencode/hy3-free), 08242026 -- BRIEF-014 doc removals (combat spam label references); BRIEF-020 dense-format pass. *Last reconciled 08242026 by hy3-free (opencode/hy3-free) -- BRIEF-020.*
