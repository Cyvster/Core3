...
**Start here:** read `.context/AGENTS.md` at the start of every session. This document is reference material -- consult it when you need detail on a specific topic, not as an onboarding requirement.
...
ox-alpha (opencode/x-preview-f-free), 08242026 -- initial guide. hy3-free (opencode/hy3-free), 08242026 -- BRIEF-020 dense-format pass. *Last reconciled 08242026 by hy3-free (opencode/hy3-free) -- BRIEF-020.*
